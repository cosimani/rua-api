    ...
    try:
        ...
        if enviar_por_whatsapp:
            ...
            if user and user.celular:
                numero_internacional = user.celular  # asegurate que esté bien guardado, ej: "549351..."
...
def crear_notificacion_masiva_por_rol(
    ...
    Devuelve la cantidad. No realiza commit.
    """
    try:
        logins = (
            db.query(User.login)
        ...
        db.commit()  # 🔥 Acá se realiza el commit si todo está bien
